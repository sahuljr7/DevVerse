...
const meta = {
  title: 'Blog',
  template: 'Sahul Kumar Parida',
  description: `I've been writing online since 2022, mostly about tech. On purpose for documentation while able to share my knowledge. Use the search below to filter by title.`
}
